...
public class UIC {
    ...
    public static class Report{
        public static void viewReport(String Inventory){
            try{
                net.sf.jasperreports.engine.design.JasperDesign jasperDesign = net.sf.jasperreports.engine.xml.JRXmlLoader.load(Inventory);
        ...
        public static void viewReport(javax.swing.JScrollPane jspReport, String Inventory){            
            try{
                java.util.HashMap parameter = new java.util.HashMap();
                java.io.File reportFile = new java.io.File(Inventory);          
